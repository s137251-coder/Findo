...
| A privacy policy hosted at a public URL | Mandatory for any app that shows ads |
...
The launcher icon in the repo is Flutter's default. Replace
`android/app/src/main/res/mipmap-*/ic_launcher.png` before release, or the app
ships with the Flutter logo.
