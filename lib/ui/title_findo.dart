...
/// Findo herself, beside the magnifier at the top of the title screen.
///
...
class TitleFindo extends StatelessWidget {
  const TitleFindo({super.key, required this.height});

  static const _clip = 'assets/images/targets/findo_idle.webp';

  /// How tall she stands, in logical pixels.
  final double height;

  @override
  Widget build(BuildContext context) {
    return IgnorePointer(
      // Flutter's Image pauses any animated image on its first frame when the
      // device asks for reduced motion, so leaving out a still fallback was
      // not enough: she stood still anyway. The request is lifted for this
      // image alone; everything else on the screen still honours it.
      child: MediaQuery(
        ...
        child: SizedBox(
          ...
          child: Image.asset(
            ...
            // The title screen rebuilds as it opens; without this the clip
            // could blank for a frame each time.
